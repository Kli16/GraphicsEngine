...
def add_pyramid( polygons, x, y, z, width, height, depth ):
    ...
    #front
    add_polygon(polygons, x, y, z, x1, y, z, avgx, y1, avgz);

    #back
    add_polygon(polygons, x, y, z1, avgx, y1, avgz, x1, y, z1);

    #right side
    add_polygon(polygons, x1, y, z, x1, y, z1, avgx, y1, avgz);

    #left side
    add_polygon(polygons, x, y, z1, x, y, z, avgx, y1, avgz);
